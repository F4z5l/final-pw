const CACHE_NAME = "codexstudys-v4";
const SEG_CACHE_NAME = "codexstudys-segments-v1";
const API_CACHE_NAME = "codexstudys-api-v1";
...
const STATIC_ASSETS = ["/", "/manifest.json", "/codexstudys-logo.png", "/codexstudys-logo.png"];
