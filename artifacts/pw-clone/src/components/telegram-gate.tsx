...
const STORAGE_KEY = "codexstudys_tg_auth";
const SESSION_KEY = "codexstudys_tg_session"; // sessionStorage key for current session
const EXPIRY_MS = 7 * 24 * 60 * 60 * 1000; // 7 days (1 week)
const CHANNEL_URL = "https://t.me/codexstudys";
