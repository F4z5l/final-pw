...
const IOS_DISMISSED_KEY = "codexstudys_ios_install_dismissed";
        ...
        >
          <div className="flex items-center gap-3 bg-card border border-primary/30 rounded-2xl shadow-2xl px-4 py-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold leading-tight">Install codexstudys App</p>
        ...
        >
          ...
          <div className="bg-card border border-primary/30 rounded-2xl shadow-2xl px-4 py-3">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold leading-tight">Install codexstudys on iPhone</p>
