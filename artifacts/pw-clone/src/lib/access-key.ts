...
const ACCESS_KEY_STORAGE = "codexstudys_access_key";
const CLAIM_TOKEN_STORAGE = "codexstudys_access_claim_token";
const PENDING_GENERATION_STORAGE = "codexstudys_pending_generation";
