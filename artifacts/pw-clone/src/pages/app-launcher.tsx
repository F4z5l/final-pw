    ...
    >
      ...
      >
        <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl overflow-hidden shadow-xl mb-3">
          <img src="/codexstudys-logo.png" alt="codexstudys Logo" className="w-full h-full object-cover" />
        </div>
        <h1 className="text-white font-black text-2xl sm:text-3xl tracking-tight mb-1">codexstudys Hub</h1>
      ...
      <div className="w-full max-w-sm sm:max-w-md grid grid-cols-2 gap-3 sm:gap-4">
        ...
        >
          ...
          <div className="w-full">
            <p className="text-white font-bold text-base leading-tight">codexstudys</p>
            <p className="text-indigo-400 text-xs mt-0.5 font-medium">Free Batches</p>
            <div className="flex items-center gap-1 mt-2">
              <TgIcon className="w-3 h-3 text-[#0088cc]" />
              <span className="text-zinc-500 text-[11px]">@codexstudys</span>
            </div>
          </div>
        </motion.button>
