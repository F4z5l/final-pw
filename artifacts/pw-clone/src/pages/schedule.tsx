...
export default function Schedule() {
  usePageMeta({
    ...
    description:
      "Check today's Physics Wallah live class schedule on codexstudys. See lecture timings, live and upcoming classes for IIT JEE and NEET batches — updated every 2 minutes.",
    canonical: "/schedule",
  });
