...
export default function Batch() {
  ...
  usePageMeta({
    ...
    description: batchName
      ? `Watch ${batchName} free batch on codexstudys. Free video lectures, DPP quizzes and study materials for IIT JEE & NEET by Physics Wallah — no subscription needed.`
      : "Watch this Physics Wallah free batch on codexstudys. Free lectures, DPP quizzes and study materials for IIT JEE & NEET.",
