...
function MixListPage() {
  usePageMeta({
    ...
    description:
      "Create your personalised study mix from Physics Wallah batches. Combine Physics from one batch, Maths from another — study exactly what you need on codexstudys.",
    canonical: "/my-mix",
  });
