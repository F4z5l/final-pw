      ...
      >
        ...
        <div className="p-6">
          ...
          <div className="text-center mb-6">
            ...
            <h2 className="text-xl font-extrabold mb-2">Join the codexstudys Community!</h2>
...
const SITE_URL = "https://codexstudys.pages.dev";
const SHARE_TEXT = "🔥 codexstudys — Physics Wallah ke saare FREE batches ek jagah! IIT JEE, NEET, Foundation — sab free! Dekho:";
