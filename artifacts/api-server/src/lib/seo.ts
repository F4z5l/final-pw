...
const SITE_URL = process.env.FRONTEND_URL ?? "https://codexstudys.pages.dev";
const SITE_NAME = "codexstudys — PW Free Batches";
const DEFAULT_IMAGE = "https://cdn.pw.live/subjects/pwicons/PW.png";
const TITLE_SUFFIX = "codexstudys";
...
const STATIC_ROUTES: Record<string, PageMeta> = {
  ...
  "/schedule": {
    ...
    description:
      "View today's Physics Wallah live class schedule. Check PW batch lecture timings for IIT JEE and NEET — updated in real time on codexstudys.",
    schema: {
      "@context": "https://schema.org",
      "@type": "WebPage",
  ...
  "/my-mix": {
    ...
    description:
      "Create your personalised study mix from Physics Wallah batches. Combine Physics from one batch, Maths from another — study your way on codexstudys.",
    schema: {
      "@context": "https://schema.org",
      "@type": "WebPage",
  ...
  "/materials": {
    ...
    description:
      "Download Physics Wallah study materials, DPP sheets, and notes for IIT JEE and NEET preparation — all free on codexstudys.",
  },
};
...
function batchMeta(batchId: string): PageMeta {
  return {
    ...
    description: `Watch this Physics Wallah free batch on codexstudys. Free video lectures, DPP quizzes, and study materials for IIT JEE & NEET preparation.`,
    schema: {
      "@context": "https://schema.org",
      "@type": "Course",
...
function subjectMeta(batchId: string, subjectId: string): PageMeta {
  return {
    ...
    description: `Browse video lectures and study material for this Physics Wallah subject on codexstudys. Free chapters, notes and DPP for IIT JEE & NEET.`,
    schema: {
      "@context": "https://schema.org",
      "@type": "ItemList",
      name: "Physics Wallah Subject Chapters",
      url: `${SITE_URL}/batch/${batchId}/subject/${subjectId}`,
      description: "Free Physics Wallah subject lectures and chapters on codexstudys.",
    },
  };
}
...
function topicMeta(
  ...
  return {
    ...
    description: `Watch free Physics Wallah video lectures for this chapter. Download notes and DPP sheets for IIT JEE & NEET preparation on codexstudys.`,
    schema: {
      "@context": "https://schema.org",
      "@type": "ItemList",
